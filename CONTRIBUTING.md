# Contributing to im-transparantie

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to
im-transparantie. These guidelines are not strict rules.
...
The im-transparantie team strives to create a
...
- Pull Requests
    ...
    - PRs should be reviewed and merged in a timely fashion by the im-transparantie technical leads
...
[issues]: https://github.com/Netbeheer-Nederland/im-transparantie/issues/
[pulls]: https://github.com/Netbeheer-Nederland/im-transparantie/pulls/
